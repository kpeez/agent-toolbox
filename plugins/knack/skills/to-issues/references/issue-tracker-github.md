...
- **Parent/sub-issues**: GitHub has no native sub-issues — the parent issue carries a task list (`- [ ] #<number>`) linking each slice, and each slice's body links back to the parent.
