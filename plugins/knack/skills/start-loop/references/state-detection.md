...
| During spec writing | Partial/unapproved `NNNN-<slug>.md` | `write-spec` | Reuse slug + existing file |
| After spec approval | Approval marker in `NNNN-<slug>.md` | `to-issues` (no gate) | Don't rerun sharpen or duplicate spec |
