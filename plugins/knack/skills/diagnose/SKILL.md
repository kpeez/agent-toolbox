...
present) to build a clear mental model, and check `docs/adr/` for decisions in
...
1. **Failing test / example** at whatever seam reaches the bug — unit, integration, e2e, or a spec example script.
