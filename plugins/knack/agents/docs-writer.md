...
- When comparisons, diffs, diagrams, experiment evidence, or structured review
  would improve the document, follow the `rich-docs` skill. Keep ordinary `.md`
  files valid Markdown unless the target has a configured rich-docs renderer.
