---
name: autoresearch
description: Run a bounded autonomous experiment loop against an approved metric and evaluator. Use for autoresearch or repeated optimization runs; not for one-off research memos or multi-lane reviews.
---
