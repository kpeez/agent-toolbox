...
<step action="gather-diff">run `git diff <base>...HEAD` to get all new/changed code; this is the only code you touch</step>
<step action="review">evaluate every changed file against the cleanup checklist below; take notes on what to fix</step>
