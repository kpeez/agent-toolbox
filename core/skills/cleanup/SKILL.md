---
name: cleanup
description: Aggressively simplify and clean up new code after implementation. Use after finishing a feature and before /ship to reduce verbosity, remove unnecessary complexity, and tighten the diff.
---
